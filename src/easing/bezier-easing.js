...
class BezierEasing {
  constructor(o){ this.vars(); return this.generate; }
  vars() { return this.generate = h.bind(this.generate, this); }
  generate(mX1, mY1, mX2, mY2){
    ...
    const binarySubdivide = function(aX, aA, aB) {
      let currentX = undefined; let currentT = undefined; i = 0;
      while (true) {
    ...
    const getTForX = function(aX) {
      ...
      const delta = (mSampleValues[currentSample + 1] - mSampleValues[currentSample]);
    ...
    const precompute = function() {
      ...
      if ((mX1 !== mY1) || (mX2 !== mY2)) { return calcSampleValues(); }
    };

    var mSampleValues = !float32ArraySupported ? new Array(kSplineTableSize)
