...
be overridden on run yet`);
  ...
  createTween() {
    this.tween = new Tween({
      ...
      onStart: () =>
        this.props.onStart != null ? this.props.onStart.apply(this) : undefined,
      onComplete: () => {
        ...
        return this.props.onComplete != null
  ...
  startTween() {
    return setTimeout(
      () => (this.timeline != null ? this.timeline.play() : undefined),
      1
    );
  }
    ...
    if (!isInit) {
      transform =
        typeof this.onUpdate === "function"
          ? this.onUpdate(p, { x, y, rotate: this.rotate })
          : undefined;
    }
