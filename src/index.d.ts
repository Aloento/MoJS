...
declare namespace mojs {
  ...
  class Thenable<T = ShapeOptions> extends Tweenable {
    /**
  ...
  interface BurstOptions {
     ...
     *  {Number, String}
     */
    angle?: number | string | { [delta: string]: number | string };
  ...
  class Timeline extends Tween {
     ...
     *  @returns {Object} Self.
     */
    add(tween: Object | any, ...args): object;
     ...
     *  @returns {Object} Self.
     */
    append(tween: Object | any[]): object;
...
declare module "mojs-player" {
  import { Shape, Timeline } from '@aloento/mojs';
