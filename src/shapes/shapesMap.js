...
class BitsMap {
  ...
  constructor(){ this.addShape = h.bind(this.addShape, this); }
  getShape(name){ return this[name] || h.error(`no \"${name}\" shape available yet, \
please choose from this list:`, [ 'circle', 'line', 'zigzag', 'rect', 'polygon', 'cross', 'equal', 'curve' ]); }
  ...
  */
  addShape(name, Module){ return this[name] = Module; }
}
BitsMap.initClass();
